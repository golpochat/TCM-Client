...
import './PlayerPayment.css'

const CreatePlayerPayment = ({ history, match }) => {
    ...
    const doSubmit = (event) => {
        ...
        axios({
            method: "POST",
            url: `${process.env.REACT_APP_API}/player-payment/create/${match.params.id}`,
            ...
            .then((response) => {
                ...
                history.push(`/admin/player/profile-admin-view/${match.params.id}`);
            })
            .catch((error) => {
        ...
        <div className="row">
            <div className="col-sm-12 col-md-6 col-lg-6 m-auto">
                <form>
                    ...
                    <Link to={`/admin/player/profile-admin-view/${match.params.id}`} className="btn btn-success btn-md mr-3">Back</Link>
    ...
    return (
        <Layout>
            <div className="container-create-player-payment">
...
export default CreatePlayerPayment;
